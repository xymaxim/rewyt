...
<style>
  ...
  :global([data-tabs-trigger]) {
    @apply flex h-10 w-12! cursor-pointer justify-center rounded-full opacity-40 shadow-none grayscale-100 outline-none! hover:grayscale-0 data-[state=active]:pointer-events-none data-[state=active]:z-20 data-[state=active]:-rotate-0 data-[state=active]:bg-neutral-600! data-[state=active]:opacity-100 data-[state=active]:grayscale-0;
  }
